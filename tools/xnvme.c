...
//	char *filepath = cli->args.cmd_input;
	...
	xnvme_cli_pinf("xnvme_nvm_firmware_download: {filepath: %s}", "/Users/komalsangale/Desktop/DextInitialCode/Forked_Repo/xNVMe/FW/B.bin");

	err = xnvme_nvm_firmware_download(&ctx, "/Users/komalsangale/Desktop/DextInitialCode/Forked_Repo/xNVMe/FW/B.bin");
	if (err || xnvme_cmd_ctx_cpl_status(&ctx)) {
